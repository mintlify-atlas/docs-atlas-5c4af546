...
<CodeGroup>
```bash cURL
curl -X GET "https://api.aero.com/v1/airports?search=VIDP" \
  -H "Authorization: Bearer YOUR_JWT_TOKEN"
```

```javascript JavaScript
const response = await fetch('https://api.aero.com/v1/airports?search=VIDP', {
  headers: {
...
response = requests.get(
    'https://api.aero.com/v1/airports',
    params={'search': 'VIDP'},
...
```bash
curl -X GET "https://api.aero.com/v1/airports?search=LAX" \
  -H "Authorization: Bearer YOUR_JWT_TOKEN"
```
...
```bash
curl -X GET "https://api.aero.com/v1/airports?search=KLAX" \
  -H "Authorization: Bearer YOUR_JWT_TOKEN"
```
...
```bash
curl -X GET "https://api.aero.com/v1/airports?search=Heathrow" \
  -H "Authorization: Bearer YOUR_JWT_TOKEN"
```
...
```bash
curl -X GET "https://api.aero.com/v1/airports?search=Tokyo" \
  -H "Authorization: Bearer YOUR_JWT_TOKEN"
```
