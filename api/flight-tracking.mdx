...
const response = await fetch('http://localhost:3000/v1/flight/search?iata=UA123&icao=UAL123&date=2024-03-20&timezone=America/Los_Angeles', {
  headers: {
...
response = requests.get(
    'http://localhost:3000/v1/flight/search',
    params={
        'iata': 'UA123',
        'icao': 'UAL123',
        'date': '2024-03-20',
...
```javascript JavaScript
const response = await fetch('http://localhost:3000/v1/flight?iata=UA123&icao=UAL123&timezone=America/Los_Angeles&faFlightId=UAL123-1710936000-airline-0123', {
  headers: {
    'Authorization': 'Bearer YOUR_JWT_TOKEN'
  }
});
...
```javascript JavaScript
const response = await fetch('http://localhost:3000/v1/flight/track?iata=UA123&icao=UAL123&date=2024-03-20&timezone=America/Los_Angeles', {
  headers: {
    'Authorization': 'Bearer YOUR_JWT_TOKEN'
  }
});
...
response = requests.get(
    'http://localhost:3000/v1/flight/track',
    params={
        'iata': 'UA123',
        'icao': 'UAL123',
        'date': '2024-03-20',
